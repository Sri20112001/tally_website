...
const StatsGrid = () => {
    return (
        <div className="md:px-4 sm:px-6 lg:px-8 md:py-16">
            <div className="max-w-8xl mx-auto">
                <h2 className="text-3xl font-bold text-center text-gray-800 my-12">Our Achievements</h2>
                    ...
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 overflow-hidden rounded-2xl">
                                <div className="md:shine absolute top-0 left-[-75%] w-1/2 h-full bg-white opacity-20 transform -skew-x-12 md:animate-shine"></div>
                            </div>
