...
const CoreService = () => {
    return (
        <div className="w-full px-4 md:px-8 md:py-12">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">Our Core Services</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {data.map((item, index) => {
                    const isEven = index % 2 === 0;
                    const Icon = item.icon; // if it's a component, we'll use this
                    ...
                    return (
                        ...
                        >
                            {/* Icon (check if URL or Component) */}
                            ...
                            {/* Label */}
                            <p className="text-xl font-bold text-blue-700 mb-2">{item.label}</p>
